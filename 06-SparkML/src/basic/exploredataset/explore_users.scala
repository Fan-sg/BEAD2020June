...
object explore_users {
  def main(args: Array[String]) {
    ...
    val user_fields = sc.textFile("C:/dev/github/BEAN2020June/06-SparkML/data/movielens/u.user").map(line => line.split("\\|"))
    ...
    val width1 = 600;
    val height1 = 400;
    ChartUtilities.saveChartAsPNG(new File("C:/dev/github/BEAN2020June/06-SparkML/data/movielens/u.user/age_histogram.png"), chart1, width1, height1);
    ...
    val width2 = 2000;
    val height2 = 500;
    ChartUtilities.saveChartAsPNG(new File("C:/dev/github/BEAN2020June/06-SparkML/data/movielens/u.user/occ_histogram.png"), chart2, width2, height2);
