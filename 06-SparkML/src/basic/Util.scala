...
object Util {
  ...
  val PATH_MOVIES = "D:/dev/GitHub/BEAD2020June/06-SparkML/data/movielens/u.item"
  val PATH_USERS =  "D:/dev/GitHub/BEAD2020June/06-SparkML/data/movielens/u.user"
  ...
  def getUserData() : RDD[String] = {
    var user_data = Util.spark.sparkContext.textFile("D:/dev/GitHub/BEAD2020June/06-SparkML/data/movielens/u.user")
    return user_data
  }
